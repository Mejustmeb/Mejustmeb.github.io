#!/bin/bash
# freewillgamed0c3 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/freewillgamed0c3" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/freewillgamed0c3"
echo "Installed freewillgamed0c3 to $BIN/freewillgamed0c3. Run: freewillgamed0c3"
