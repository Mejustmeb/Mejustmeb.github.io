#!/bin/bash
# resonantlanguage808d 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/resonantlanguage808d" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/resonantlanguage808d"
echo "Installed resonantlanguage808d to $BIN/resonantlanguage808d. Run: resonantlanguage808d"
