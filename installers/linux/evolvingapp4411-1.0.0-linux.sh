#!/bin/bash
# evolvingapp4411 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/evolvingapp4411" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/evolvingapp4411"
echo "Installed evolvingapp4411 to $BIN/evolvingapp4411. Run: evolvingapp4411"
