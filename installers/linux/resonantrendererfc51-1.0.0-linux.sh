#!/bin/bash
# resonantrendererfc51 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/resonantrendererfc51" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/resonantrendererfc51"
echo "Installed resonantrendererfc51 to $BIN/resonantrendererfc51. Run: resonantrendererfc51"
