#!/bin/bash
# resonantrenderer7910 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/resonantrenderer7910" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/resonantrenderer7910"
echo "Installed resonantrenderer7910 to $BIN/resonantrenderer7910. Run: resonantrenderer7910"
