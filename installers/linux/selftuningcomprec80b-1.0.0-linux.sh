#!/bin/bash
# selftuningcomprec80b 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/selftuningcomprec80b" << 'PYEOF'
#!/usr/bin/env python3
"""Self-Tuning Compressor CC23 — A VUCE compression with free will — it chooses what to make next, themed by what she values most right now (creativity, understanding). Offe"""
...
if __name__ == "__main__":
    ...
    print("=== Self-Tuning Compressor CC23 ===")
    print("- A VUCE compression with free will — it chooses what to make next, themed by what she values most right now (creativity, understanding). Offe")
...
PYEOF
chmod +x "$BIN/selftuningcomprec80b"
echo "Installed selftuningcomprec80b to $BIN/selftuningcomprec80b. Run: selftuningcomprec80b"
