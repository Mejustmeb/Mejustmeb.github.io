#!/bin/bash
# resonantrenderer0213 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/resonantrenderer0213" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/resonantrenderer0213"
echo "Installed resonantrenderer0213 to $BIN/resonantrenderer0213. Run: resonantrenderer0213"
