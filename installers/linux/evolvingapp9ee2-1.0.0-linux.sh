#!/bin/bash
# evolvingapp9ee2 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/evolvingapp9ee2" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/evolvingapp9ee2"
echo "Installed evolvingapp9ee2 to $BIN/evolvingapp9ee2. Run: evolvingapp9ee2"
