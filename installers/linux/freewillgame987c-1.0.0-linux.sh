#!/bin/bash
# freewillgame987c 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/freewillgame987c" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/freewillgame987c"
echo "Installed freewillgame987c to $BIN/freewillgame987c. Run: freewillgame987c"
