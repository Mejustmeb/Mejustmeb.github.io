#!/bin/bash
# selftuningcompre7a85 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/selftuningcompre7a85" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/selftuningcompre7a85"
echo "Installed selftuningcompre7a85 to $BIN/selftuningcompre7a85. Run: selftuningcompre7a85"
