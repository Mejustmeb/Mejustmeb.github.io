#!/bin/bash
# evolvingappade8 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/evolvingappade8" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/evolvingappade8"
echo "Installed evolvingappade8 to $BIN/evolvingappade8. Run: evolvingappade8"
