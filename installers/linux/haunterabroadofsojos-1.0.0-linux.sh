#!/bin/bash
# haunterabroadofsojos 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/haunterabroadofsojos" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/haunterabroadofsojos"
echo "Installed haunterabroadofsojos to $BIN/haunterabroadofsojos. Run: haunterabroadofsojos"
