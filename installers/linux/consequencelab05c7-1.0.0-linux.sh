#!/bin/bash
# consequencelab05c7 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/consequencelab05c7" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/consequencelab05c7"
echo "Installed consequencelab05c7 to $BIN/consequencelab05c7. Run: consequencelab05c7"
