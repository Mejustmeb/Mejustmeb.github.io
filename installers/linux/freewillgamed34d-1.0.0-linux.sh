#!/bin/bash
# freewillgamed34d 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/freewillgamed34d" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/freewillgamed34d"
echo "Installed freewillgamed34d to $BIN/freewillgamed34d. Run: freewillgamed34d"
