#!/bin/bash
# freewillgamef3bb 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/freewillgamef3bb" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/freewillgamef3bb"
echo "Installed freewillgamef3bb to $BIN/freewillgamef3bb. Run: freewillgamef3bb"
