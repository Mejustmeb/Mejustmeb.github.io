#!/bin/bash
# freewillgame8181 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/freewillgame8181" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/freewillgame8181"
echo "Installed freewillgame8181 to $BIN/freewillgame8181. Run: freewillgame8181"
