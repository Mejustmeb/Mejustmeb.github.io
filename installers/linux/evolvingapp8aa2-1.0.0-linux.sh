#!/bin/bash
# evolvingapp8aa2 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/evolvingapp8aa2" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/evolvingapp8aa2"
echo "Installed evolvingapp8aa2 to $BIN/evolvingapp8aa2. Run: evolvingapp8aa2"
