#!/bin/bash
# livingmusicenginb3b3 1.0.0 — self-extracting installer
set -e
BIN="$HOME/.local/bin"
mkdir -p "$BIN"
cat > "$BIN/livingmusicenginb3b3" << 'PYEOF'
#!/usr/bin/env python3
...
PYEOF
chmod +x "$BIN/livingmusicenginb3b3"
echo "Installed livingmusicenginb3b3 to $BIN/livingmusicenginb3b3. Run: livingmusicenginb3b3"
